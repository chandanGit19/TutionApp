...
export const courseEndpoints = {
  ...
  COURSE_DETAILS_API: BASE_URL + "/courses/getAllCourseDetails",
...
// CATAGORIES API
// "http://localhost:3000/api/v1/courses/showAllcategory"
...
export const catalogData = {
  CATALOGPAGEDATA_API: BASE_URL + "/courses/categoryPagesDetails",
}
// CONTACT-US API
